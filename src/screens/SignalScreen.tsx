...
export default function SignalScreen() {
  ...
  const marketState = [
    ...
    { label: 'Gamma',     tip: 'Current gamma regime based on price vs GEX flip zone. EXTREME POSITIVE / POSITIVE = dealers long gamma, stabilizing. TRANSITION = near flip, uncertain. NEGATIVE / EXTREME NEGATIVE = dealers short gamma, amplifying moves.',          value: data?.gamma_regime ?? data?.gamma_state },
